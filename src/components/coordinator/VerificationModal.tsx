...
const REQUIRED_DOCUMENTS = [
  ...
  { name: 'Previous Wedding Portfolio/References', required: true },
  { name: 'Proof of Address (optional)', required: false },
];

export function CoordinatorVerificationModal({
  isOpen,
  onClose,
  coordinatorId,
  businessName,
    ...
    try {
      for (let i = 0; i < fileArray.length; i++) {
        ...
        const result: CloudinaryUploadResult = await uploadToCloudinary(file, {
          folder: `wedding-bazaar/coordinator-verification/${coordinatorId}`,
  ...
  }, [canUpload, documents.length, coordinatorId]);
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-dark-900 border border-dark-700 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="sticky top-0 bg-dark-900 border-b border-dark-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Coordinator Verification</h2>
          ...
          {verificationStatus === 'verified' && (
            <div className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-green-400">Verified Coordinator</p>
