...
-- Successful logins
INSERT INTO login_attempts (user_id, email, ip_address, location, success, user_agent, created_at) VALUES
(26, 'admin@weddingbazaar.ph', '192.168.1.1', 'Manila, PH', 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0', '2026-02-24 08:00:00'),
(26, 'admin@weddingbazaar.ph', '192.168.1.1', 'Manila, PH', 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0', '2026-02-23 09:15:00'),
(27, 'coupletest@example.com', '192.168.1.50', 'Quezon City, PH', 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0) Safari/605.1', '2026-02-24 07:30:00'),
(27, 'coupletest@example.com', '192.168.1.50', 'Quezon City, PH', 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0) Safari/605.1', '2026-02-22 14:20:00'),
(2, 'couple@example.com', '192.168.1.100', 'Makati, PH', 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7) Safari/605.1', '2026-02-23 11:00:00');

-- Failed login attempts (for security monitoring)
INSERT INTO login_attempts (user_id, email, ip_address, location, success, failure_reason, user_agent, created_at) VALUES
(NULL, 'admin@weddingbazaar.ph', '45.33.32.156', 'Unknown', 0, 'Invalid password', 'Mozilla/5.0 (Linux; Android) AppleWebKit/537.36', '2026-02-24 03:15:00'),
(NULL, 'admin@weddingbazaar.ph', '45.33.32.156', 'Unknown', 0, 'Invalid password', 'Mozilla/5.0 (Linux; Android) AppleWebKit/537.36', '2026-02-24 03:15:30'),
(NULL, 'admin@weddingbazaar.ph', '45.33.32.156', 'Unknown', 0, 'Invalid password', 'Mozilla/5.0 (Linux; Android) AppleWebKit/537.36', '2026-02-24 03:16:00'),
(NULL, 'test@hacker.com', '103.25.41.82', 'Unknown', 0, 'User not found', 'curl/7.64.1', '2026-02-23 22:45:00'),
(NULL, 'root@weddingbazaar.ph', '103.25.41.82', 'Unknown', 0, 'User not found', 'curl/7.64.1', '2026-02-23 22:45:05'),
(NULL, 'coupletest@example.com', '192.168.1.50', 'Quezon City, PH', 0, 'Invalid password', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0) Safari/605.1', '2026-02-24 07:28:00'),
(NULL, 'coupletest@example.com', '192.168.1.50', 'Quezon City, PH', 0, 'Invalid password', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0) Safari/605.1', '2026-02-24 07:29:00');
